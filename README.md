...
### 2. `samples/pbrt_viewer` — PBRT 场景查看器
...
cmake --build . --config Release --target pbrt_viewer
```

产物：`out\bin/Release/pbrt_viewer.exe`

## 运行

```bat
out\bin\Release\pbrt_viewer.exe --scene D:\gitProject\VLR_WF\models\kitchen\scene-v4.pbrt
```
